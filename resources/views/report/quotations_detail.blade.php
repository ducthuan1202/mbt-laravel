...
@section('content')
    <div class="right_col" role="main">
        ...
        <div class="alert alert-success">
            <h3>{{$data->name}}</h3>
            <h4>Thống kê {{count($data->quotations)}} lượt báo giá thời gian từ: {{$date}}</h4>
        </div>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="x_panel tile">
                    <div class="x_title">
                        <h2><i class="fa fa-bullhorn"></i> Báo giá: <small>{{$date}}</small></h2>
                        <div class="clearfix"></div>
                    </div>
                    ...
                    <div class="x_content">
                        <div class="table-responsive">
                            <table class="table jambo_table bulk_action">
                                ...
                                <tbody>
                                @if($data)
                                    @foreach($data->quotations as $index => $item)
                                        <tr>
                                            <td>{{$index + 1}}</td>
